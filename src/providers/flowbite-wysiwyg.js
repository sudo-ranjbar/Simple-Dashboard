...
export default function WYSIWYGScript() {

  useEffect(() => {

    const runScriptAfterDomLoaded = () => {
      ...
      if (document.getElementById("wysiwyg")) {
          ...
          document.getElementById('toggleHighlightButton').addEventListener('click', () => {
            ...
            // when using toggleHighlight(), judge if it is already highlighted.
    ...
    if (document.readyState === "complete") {
      ...
      return () => window.removeEventListener("load", runScriptAfterDomLoaded);
    }
